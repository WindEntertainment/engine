...
namespace wind {
  ...
  class LangImpl {
  public:
    virtual void compile(wi::Value*) = 0;
    virtual void compile(wi::Identifier*) = 0;
    virtual void compile(wi::UnaryOperation*) = 0;
    virtual void compile(wi::BinaryOperation*) = 0;
    virtual void compile(wi::AssignStatement*) = 0;
    virtual void compile(wi::VariableStatement*) = 0;
    virtual void compile(wi::ClassMember*) = 0;
    virtual void compile(wi::ClassStatement*) = 0;
    virtual void compile(wi::FunctionArgumentStatement*) = 0;
    virtual void compile(wi::FunctionStatement*) = 0;
    virtual void compile(wi::ReturnStatement*) = 0;
  };
