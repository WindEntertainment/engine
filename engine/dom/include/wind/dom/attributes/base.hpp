...
namespace wind::dom::attributes {
  struct Base {
    ...
    bool compareBase(const std::shared_ptr<attributes::Base> attributes) {
      return std::tie(
               this->disabled,
               this->position,
               this->size,
    ...
    virtual bool compare(std::shared_ptr<attributes::Base> attributes) = 0;

    bool operator==(const std::shared_ptr<attributes::Base> element) {
      return compareBase(element) && compare(element);
    };
  };
} // namespace wind::dom::attributes
