...
namespace wind::dom::shadow {
  ...
  public:
    ...
    shadow::attributes::Root attributes =
      shadow::attributes::getDefaultRootAttributes();
    shadow::attributes::Root hoverAttributes = {};
    shadow::attributes::Root clickAttributes = {};
  };
} // namespace wind::dom::shadow
