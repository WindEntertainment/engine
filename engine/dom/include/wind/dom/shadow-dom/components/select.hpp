...
namespace wind::dom::shadow {
  ...
  public:
    ...
    shadow::attributes::Select attributes =
      shadow::attributes::getDefaultSelectAttributes();
    shadow::attributes::Select hoverAttributes = {};
    shadow::attributes::Select clickAttributes = {};
  };
} // namespace wind::dom::shadow
