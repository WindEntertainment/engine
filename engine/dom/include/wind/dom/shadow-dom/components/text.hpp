...
namespace wind::dom::shadow {
  ...
  public:
    ...
    shadow::attributes::Text attributes =
      shadow::attributes::getDefaultTextAttributes();
    shadow::attributes::Text hoverAttributes = {};
    shadow::attributes::Text clickAttributes = {};
  };
} // namespace wind::dom::shadow
